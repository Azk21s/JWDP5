...
function displayProduct(product) {
	getElementById("productName").textContent = product.name;
	getElementById("productQt").selectedIndex = product.quantity - 1;
	getElementById("productPrice").textContent = product.price / 100 + ".00€";
	getElementById("productTotal").textContent = (product.price * product.quantity) / 100 + ".00€";

	// Add events
	getElementById("productQuantity").addEventListeners("change", e => {
		e.preventDefault();
